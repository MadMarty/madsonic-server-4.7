...
public class LeftController extends ParameterizableViewController {
    ...
    static {
        LAST_COMPATIBILITY_TIME.set(2012, Calendar.SEPTEMBER, 21, 0, 0, 0);
    ...
    protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        List<MusicFolder> allMusicFolders = settingsService.getAllMusicFolders(userGroupId);
        MusicFolder selectedMusicFolder = getSelectedMusicFolder(request);
    ...
    public MusicFolderContent getMusicFolderContent(List<MusicFolder> musicFoldersToUse, boolean refresh) throws Exception {
        ...
        SortedMap<MusicIndex, SortedSet<MusicIndex.SortableArtistWithMediaFiles>> indexedArtists = musicIndexService.getIndexedArtists(musicFoldersToUse, refresh, TempIndex);
