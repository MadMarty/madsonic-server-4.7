...
public class AlbumDao extends AbstractDao {
    ...
    private static final String COLUMNS = "id, path, name, SetName, artist, song_count, duration_seconds, cover_art_path, " +
    ...
    public synchronized void createOrUpdateAlbum(Album album) {
        ...
        if (n == 0) {
            ...
            update("insert into album (" + COLUMNS + ") values (" + questionMarks(COLUMNS) + ")", null, album.getPath(), album.getName(), album.getSetName(), album.getArtist(),
