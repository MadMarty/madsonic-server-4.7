...
public class MusicIndexService {
    ...
    private <T extends SortableArtist> SortedMap<MusicIndex, SortedSet<T>> sortArtists(SortedSet<T> artists, int index) {
        ...
        {
           case 4:
               indexes = createIndexesFromExpression(settingsService.getIndex4String()); break;
           case 3:
               indexes = createIndexesFromExpression(settingsService.getIndex3String()); break;
           case 2:
               indexes = createIndexesFromExpression(settingsService.getIndex2String()); break;
           default:
        	   indexes = createIndexesFromExpression(settingsService.getIndexString());
        }
