...
public class MediaFile {
    ...
    public MediaFile(int id, String path, String folder, MediaType mediaType, boolean override, String format, String title,
                     String albumName, String albumSetName, String artist, String albumArtist, Integer discNumber, Integer trackNumber, Integer year, String genre, Integer bitRate,
