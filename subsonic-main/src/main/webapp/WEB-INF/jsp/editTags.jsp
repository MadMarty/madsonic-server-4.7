...
<script type="text/javascript" language="javascript">
    ...
    function updateNextTag() {
        ...
        tagService.setTags(id, track, artist, albumartist, album, title, year, genre, setTagsCallback);
    }
...
<table class="ruleTable indent">
    ...
    <tr>
        ...
        <th class="ruleTableHeader" style="white-space: nowrap"><input type="text" name="albumAll" size="20" onkeypress="dwr.util.onReturn(event, setAlbum)" value="${model.defaultAlbum}"/>&nbsp;<a href="javascript:setAlbum()"><fmt:message key="edittags.set"/></a></th>
    ...
    <c:forEach items="${model.songs}" var="song" varStatus="loopStatus">
        <tr>
            ...
            <td nowrap="nowrap" class="ruleTableCell"><input type="text" size="10" name="track${loopStatus.count - 1}" value="${song.track}"/></td>
            ...
            <td class="ruleTableCell"><input type="text" size="20" name="album${loopStatus.count - 1}" value="${song.album}"/></td>
