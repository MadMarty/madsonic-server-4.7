...
<table class="indent">
    ...
    <c:forEach items="${model.transcodings}" var="transcoding">
        <tr>
            ...
            <td><input style="font-family:monospace" type="text" name="step2[${transcoding.id}]" size="30" value="${transcoding.step2}"/></td>
            <td><input style="font-family:monospace" type="text" name="step3[${transcoding.id}]" size="30" value="${transcoding.step3}"/></td>
    ...
    <tr>
        ...
        <td><input style="font-family:monospace" type="text" name="step2" size="30" value="${model.newTranscoding.step2}"/></td>
        <td><input style="font-family:monospace" type="text" name="step3" size="30" value="${model.newTranscoding.step3}"/></td>
        <td/>
    </tr>
