...
<table width="75%" class="ruleTable indent">
    ...
    <tr><td class="ruleTableHeader"><fmt:message key="help.madsonic_forum.title"/></td><td class="ruleTableCell"><a target="_blank" href="http://forum.madsonic.org/">forum.madsonic.org</a> **NEW**<img style="float:right;margin-left: 10px" alt="Madsonic" src="<c:url value="/icons/madsonic_banner.png"/>"></td></tr>
    <tr><td class="ruleTableHeader"><fmt:message key="help.madsonic_homepage.title"/></td><td class="ruleTableCell"><a target="_blank" href="http://www.madsonic.org/">madsonic.org</a> **NEW**<img style="float:right;margin-left: 10px" alt="Madsonic" src="<c:url value="/icons/madsonic_banner.png"/>"></td></tr>
