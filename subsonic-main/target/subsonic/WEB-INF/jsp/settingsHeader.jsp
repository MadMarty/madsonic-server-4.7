...
<c:set var="categories" value="${param.restricted ? 'personal password player share' : 'musicFolder general advanced personal user group access player share network transcoding internetRadio podcast cleanup'}"/>
<h1>
